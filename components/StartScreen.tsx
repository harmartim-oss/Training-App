...
import { UploadIcon, MagicWandIcon, PaletteIcon, SunIcon, LogoIcon } from './icons';
  ...
  return (
    ...
    >
      <div className="flex flex-col items-center gap-6 animate-fade-in">
        <LogoIcon className="w-20 h-20 mb-2" />
        <h1 className="text-5xl font-extrabold tracking-tight text-gray-100 sm:text-6xl md:text-7xl">
          AI-Powered Photo Editing, <span className="bg-gradient-to-r from-cyan-400 to-blue-500 text-transparent bg-clip-text">Simplified</span>.
        </h1>
