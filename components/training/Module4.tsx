...
const Module4: React.FC<ModuleProps> = ({ onComplete, onNavigate }) => {
    ...
    const questions = {
        q1: { question: "Under FIPPA, where must Ontario municipalities generally store personal information?", answer: 'b', options: { a: "Anywhere in North America", b: "Within Canada", c: "Within Ontario only" }},
        q2: { question: "What is the typical retention period for employee files after termination in Ontario?", answer: 'c', options: { a: "3 years", b: "5 years", c: "7 years" }},
    };
        ...
        <section className="animate-fade-in">
            <div className="max-w-4xl mx-auto">
                <div className="bg-card border border-border rounded-xl p-6 sm:p-8 shadow-sm">
                    <h1 className="text-3xl font-bold text-text-primary mb-2">Module 4: Data Management Best Practices</h1>
                    <p className="text-text-secondary mb-6">Ensuring data is classified, retained, and handled securely.</p>

                    <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-8">
                        <h3 className="font-semibold text-primary mb-2 text-lg">Learning Objectives</h3>
                        <ul className="text-blue-800 space-y-1 list-disc list-inside">
                            <li>Implement data classification and handling procedures</li>
                            <li>Establish records management and retention policies</li>
                            <li>Ensure cross-border data storage compliance</li>
                        </ul>
                    </div>

                    <div className="space-y-8 mb-8 text-text-secondary leading-relaxed">
                        <div>
                            <h3 className="text-2xl font-semibold mb-2 text-text-primary">Data Classification</h3>
                        ...
                        <div>
                            <h3 className="text-2xl font-semibold mb-2 text-text-primary">Records Retention</h3>
                    ...
                    <div className="flex flex-col sm:flex-row justify-between items-center gap-4 border-t border-border pt-6">
                        <button onClick={() => onNavigate('module3')} className="w-full sm:w-auto bg-slate-100 text-text-secondary font-semibold py-2 px-6 rounded-lg hover:bg-slate-200 transition-colors">
                            Previous Module
                        </button>
